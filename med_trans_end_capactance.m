% D:\314126514017\med_trans_end_capactance.m
...
for l = 10 : 10 : 130
    ...
    percent_regulation(k) = ((abs(V_no_load) - abs(V_r)) / abs(V_r)) * 100;
...
disp('power at the sending end');
disp(P_r + total_losses(13));
